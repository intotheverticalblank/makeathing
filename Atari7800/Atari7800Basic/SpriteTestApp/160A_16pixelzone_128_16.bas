 ...
 incgraphic zonebg80x16_16.png 160A 0 2 3 1
...
_title
 ...
 plotchars '160a zoneheight 16' 7 47 7 1
...
_screen
 ...
 for i = 0 to n
   for j = 0 to m
    if ex = 1 && wrap = 0 then plotsprite ex1 c x y f 
    if ex = 0 && wrap = 0 then plotsprite  g16x16_4color c x y f
