 ...
 incgraphic g16x16_12_1.png 160B 0 3 4 7 6 8 5 9 10 11 12 1 2 
 incgraphic g16x16_12_2.png 160B 0 1 2 3 5 6 7 9 10 11 13 14 15 
 incgraphic g16x16_4color.png 160A
 incgraphic g16x16_4color2.png 160A
 incgraphic g16x16_4color3.png 160A
 incgraphic g16x16_4color4.png 160A 
 incgraphic g16x16_4color5.png 160A
 incgraphic g16x16_4color6.png 160A
 incgraphic g16x16_4color7.png 160A
 incgraphic g16x16_4color8.png 160A 
 incgraphic zonebg80x16_16.png 160A
 incgraphic ex1.png 160A
 incgraphic ex2.png 160A
 incgraphic ex3.png 160A
 incgraphic ex4.png 160A
 incgraphic ex5.png 160A
 incgraphic ex6.png 160A
 incgraphic ex7.png 160A
 incgraphic p1.png 160A
 incgraphic blank.png 160A
 ...
 characterset font
 rem $02 $03 $05 $06 $07 $09 $0b $40 $32 $35 $38 $3B
 rem blue
 P0C1=$58 ;$02
 P0C2=$03
 P0C3=$05
...
_title
 clearscreen
 plotchars 'demo 1' 7 67 3 1
 plotchars 'atari 7800 basic exploration' 1 23 5 1
 plotchars '160b zoneheight 16' 7 47 7 1
...
_screen7_loop
 gosub _screen 
 if w > 8 && joy0fire then w = 0 : goto _screen8_init
 w = w + 1
 goto _screen7_loop
...
_screen
 ...
 for i = 0 to n
   for j = 0 to m
    if ex = 1 && wrap = 0 then plotsprite ex1 0 x y f 
    if ex = 0 && wrap = 0 then plotsprite g16x16_12_2 0 x y f
    if wrap = 1 then plotsprite  p1 7 x y 0
    x = x + 16
    if x > 144 then x = 0 : wrap = 1
  next 
  wrap = 0
  x = 0
  y = y + 16      
 ...
 if an = 1 && f > 7 then f = 0
  ...
  plotvalue font 4 s 2 8 11 
  plotvalue font 4 r 2 24 11 
  plotvalue font 4 z 2 40 11 
  plotvalue font 4 bg 2 56 11
  plotvalue font 4 an 2 72 11
  plotvalue font 4 db 2 88 11
...
drawZoneBG
 ...
 for j = 0 to 10
  for i = 0 to 1
   plotsprite  zonebg80x16_16 7 x y 0
   x = x + 80
  next
  x = 0
  y = y + 16
